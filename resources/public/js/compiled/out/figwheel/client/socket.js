...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__35183){
...
var opts = map__35185__$1;
var build_id = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var websocket_url = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var retried_count = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var retry_count = cljs.core.get.call(null,map__35185__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count){
...
var and__16579__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__16579__auto__){
var and__16579__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__16579__auto____$1)){
var and__16579__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
var retried_count__$1 = (function (){var or__16591__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count))
,(function (){var x__16910__auto__ = (10000);
var y__16911__auto__ = ((2000) + ((500) * retried_count__$1));
return ((x__16910__auto__ < y__16911__auto__) ? x__16910__auto__ : y__16911__auto__);
})());
} else {
return null;
}
...
socket.onerror = ((function (url,socket,WebSocket,temp__4124__auto__,map__35185,map__35185__$1,opts,build_id,websocket_url,retried_count,retry_count){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1427705350420